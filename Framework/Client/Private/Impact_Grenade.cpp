...
HRESULT CImpact_Grenade::Initialize_Prototype()
{
	return S_OK;
}
...
HRESULT CImpact_Grenade::Render()
{
...
HRESULT CImpact_Grenade::Add_Components()
{
	/* For.Com_Shader */
...
HRESULT CImpact_Grenade::Bind_ShaderResources()
{
...
CImpact_Grenade * CImpact_Grenade::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	...
	{
		MSG_BOX(TEXT("Failed To Created : CImpact_Grenade"));
