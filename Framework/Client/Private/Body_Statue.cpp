...
void CBody_Statue::Late_Tick(_float fTimeDelta)
{
	...
	case CStatue::STATE_PLAY:
		...
		/* LN : 손에서 봉을 놨을 때  : sound_Map_sm41_wisdom_statue2_3*/
...
HRESULT CBody_Statue::Render_LightDepth_Dir()
{
...
HRESULT CBody_Statue::Render_LightDepth_Point()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
...
HRESULT CBody_Statue::Render_LightDepth_Spot()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
