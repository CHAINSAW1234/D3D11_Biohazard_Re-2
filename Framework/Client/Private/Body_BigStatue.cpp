...
CBody_BigStatue::CBody_BigStatue(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CPart_InteractProps{ pDevice, pContext }
{
}

CBody_BigStatue::CBody_BigStatue(const CBody_BigStatue& rhs)
	: CPart_InteractProps{ rhs }
{

}

HRESULT CBody_BigStatue::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CBody_BigStatue::Initialize(void* pArg)
{
...
void CBody_BigStatue::Tick(_float fTimeDelta)
{
...
HRESULT CBody_BigStatue::Render()
{
	if (m_bRender == false)
		return S_OK;
	else
...
HRESULT CBody_BigStatue::Render_LightDepth_Dir()
{
...
HRESULT CBody_BigStatue::Render_LightDepth_Point()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
...
HRESULT CBody_BigStatue::Render_LightDepth_Spot()
{
	if (m_bRender == false)
		return S_OK;
...
HRESULT CBody_BigStatue::Add_Components()
{
	/* For.Com_Body_Shader */
...
HRESULT CBody_BigStatue::Add_PartObjects()
{

	return S_OK;
}

HRESULT CBody_BigStatue::Initialize_PartObjects()
{
	return S_OK;
}


CBody_BigStatue* CBody_BigStatue::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CBody_BigStatue* pInstance = new CBody_BigStatue(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CBody_BigStatue"));
...
CGameObject* CBody_BigStatue::Clone(void* pArg)
{
	CBody_BigStatue* pInstance = new CBody_BigStatue(*this);
