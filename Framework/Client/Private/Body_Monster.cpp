...
HRESULT CBody_Monster::Render_LightDepth_Dir()
{
...
HRESULT CBody_Monster::Render_LightDepth_Point()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
...
HRESULT CBody_Monster::Render_LightDepth_Spot()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
...
HRESULT CBody_Monster::Initialize_Model()
{
...
HRESULT CBody_Monster::Add_Components()
{
	/* For.Com_Shader */
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_ZombieBody"),
...
CBody_Monster* CBody_Monster::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	...
	{
		MSG_BOX(TEXT("Failed To Created : CBody_Monster"));
