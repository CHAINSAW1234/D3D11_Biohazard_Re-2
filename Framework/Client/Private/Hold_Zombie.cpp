...
void CHold_Zombie::Enter()
{
	...
	if (0 == iRandom)
		m_pGameInstance->Play_Sound(TEXT("em0_media.bnk.2_9.mp3"), 0);
	if (1 == iRandom)
		m_pGameInstance->Play_Sound(TEXT("em0_media.bnk.2_45.mp3"), 0);
	if (2 == iRandom)
		m_pGameInstance->Play_Sound(TEXT("em0_media.bnk.2_69.mp3"), 0);
	if (3 == iRandom)
		m_pGameInstance->Play_Sound(TEXT("em0_media.bnk.2_73.mp3"), 0);
	if (4 == iRandom)
		m_pGameInstance->Play_Sound(TEXT("em0_media.bnk.2_74.mp3"), 0);
	if (5 == iRandom)
		m_pGameInstance->Play_Sound(TEXT("em0_media.bnk.2_82.mp3"), 0);
	if (6 == iRandom)
		m_pGameInstance->Play_Sound(TEXT("em0_media.bnk.2_127.mp3"), 0);
