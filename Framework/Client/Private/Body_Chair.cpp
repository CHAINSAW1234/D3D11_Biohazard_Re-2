...
CBody_Chair::CBody_Chair(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CPart_InteractProps{ pDevice, pContext }
{
}

CBody_Chair::CBody_Chair(const CBody_Chair& rhs)
	: CPart_InteractProps{ rhs }
{

}

HRESULT CBody_Chair::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CBody_Chair::Initialize(void* pArg)
{
...
void CBody_Chair::Tick(_float fTimeDelta)
{
...
HRESULT CBody_Chair::Render_LightDepth_Dir()
{
...
HRESULT CBody_Chair::Render_LightDepth_Point()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
...
HRESULT CBody_Chair::Render_LightDepth_Spot()
{
	if (m_bRender == false)
		return S_OK;
...
HRESULT CBody_Chair::Add_Components()
{
...
HRESULT CBody_Chair::Add_PartObjects()
{

	return S_OK;
}

HRESULT CBody_Chair::Initialize_PartObjects()
{

	return S_OK;
}

HRESULT CBody_Chair::Initialize_Model()
{
...
_float4 CBody_Chair::Get_Pos(_int iArg)
{
...
//void CBody_Chair::Get_SpecialBone_Rotation()
//{
...
CBody_Chair* CBody_Chair::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CBody_Chair* pInstance = new CBody_Chair(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CBody_Chair"));
...
CGameObject* CBody_Chair::Clone(void* pArg)
{
	CBody_Chair* pInstance = new CBody_Chair(*this);
