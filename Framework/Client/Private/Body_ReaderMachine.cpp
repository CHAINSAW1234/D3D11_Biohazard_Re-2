...
CBody_ReaderMachine::CBody_ReaderMachine(const CBody_ReaderMachine& rhs)
	: CPart_InteractProps{ rhs }
{

}

HRESULT CBody_ReaderMachine::Initialize_Prototype()
{
	return S_OK;
}
...
void CBody_ReaderMachine::Tick(_float fTimeDelta)
{
...
HRESULT CBody_ReaderMachine::Render()
{
	if (m_bRender == false)
		return S_OK;
	else
...
HRESULT CBody_ReaderMachine::Render_LightDepth_Dir()
{
...
HRESULT CBody_ReaderMachine::Render_LightDepth_Point()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
...
HRESULT CBody_ReaderMachine::Render_LightDepth_Spot()
{
	if (m_bRender == false)
		return S_OK;
...
HRESULT CBody_ReaderMachine::Add_Components()
{
	/* For.Com_Body_Shader */
...
HRESULT CBody_ReaderMachine::Add_PartObjects()
{

	return S_OK;
}

HRESULT CBody_ReaderMachine::Initialize_PartObjects()
{
	return S_OK;
}


CBody_ReaderMachine* CBody_ReaderMachine::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CBody_ReaderMachine* pInstance = new CBody_ReaderMachine(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX(TEXT("Failed To Created : CBody_ReaderMachine"));
...
CGameObject* CBody_ReaderMachine::Clone(void* pArg)
{
	CBody_ReaderMachine* pInstance = new CBody_ReaderMachine(*this);
