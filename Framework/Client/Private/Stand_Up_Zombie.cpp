...
void CStand_Up_Zombie::Enter()
{
	...
	if (0 == iRandom)
		m_pGameInstance->Play_Sound(TEXT("em0_media.bnk.2_22.mp3"), 0);
	if (1 == iRandom)
		m_pGameInstance->Play_Sound(TEXT("em0_media.bnk.2_35.mp3"), 0);
	if (2 == iRandom)
		m_pGameInstance->Play_Sound(TEXT("em0_media.bnk.2_48.mp3"), 0);
	if (3 == iRandom)
		m_pGameInstance->Play_Sound(TEXT("em0_media.bnk.2_33.mp3"), 0);
	
	m_pGameInstance->Stop_Sound(1);
	m_pGameInstance->Play_Sound(TEXT("em0_media.bnk.2_115.mp3"), 0);
