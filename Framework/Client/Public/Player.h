...
public:
	...
	void													Set_Lever_Setting(_int iLever_Setting, _float4x4 LeverWorldMatrix = _float4x4()) { m_iLadder_Setting = iLever_Setting; m_Lever_WorldMatrix = LeverWorldMatrix; } //욤
