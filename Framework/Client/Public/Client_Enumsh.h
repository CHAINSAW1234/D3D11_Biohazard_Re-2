...
namespace Client
{
	...
	enum MONSTER_STATE { MST_IDLE, MST_WALK, MST_BITE, MST_KNOCK, MST_SLEEP, MST_TURN, MST_LIGHTLY_HOLD, MST_HOLD, MST_DEFAULT, MST_DAMAGE, MST_DOWN, MST_STANDUP, MST_TURNOVER, MST_END };
