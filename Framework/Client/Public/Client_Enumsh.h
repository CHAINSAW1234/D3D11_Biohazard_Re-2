...
namespace Client
{
	...
	enum class UI_TUTORIAL_TYPE { TUTORIAL_WALK, TUTORIAL_AROUND, TUTORIAL_RUN, TUTORIAL_REROAD, TUTORIAL_AIM, TUTORIAL_EQUIP, INVENTORY_OPEN, TUTORIAL_HOLD, TUTORIAL_END };
	...
	enum MONSTER_STATE { MST_IDLE, MST_WALK, MST_WALK_LOST, MST_BITE, MST_BITE_LOST, MST_CREEP, 
		MST_LOST_IDLE, 
		...
		MST_SLEEP, MST_TURN, MST_TURN_LOST, MST_LIGHTLY_HOLD, MST_HOLD, MST_DEFAULT, 
		MST_DAMAGE, MST_DAMAGE_HOLD, MST_DAMAGE_LOST,
		MST_START_HIDE_LOCKER, MST_START_DEAD,
		MST_DOWN, MST_STANDUP, MST_TURNOVER, MST_END };
