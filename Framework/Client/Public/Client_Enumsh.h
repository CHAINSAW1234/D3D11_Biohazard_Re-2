...
namespace Client
{
	...
	enum UI_OPERRATION{ POP_UP, UI_IDLE, UI_SECOND_IDLE, HIDE, STATE_END };
	...
	enum MONSTER_STATE { MST_IDLE, MST_WALK, MST_BITE, MST_KNOCK_WINDOW, MST_BREAK_WINDOW, MST_IN_WINDOW, MST_BREAK_IN_WINDOW, MST_HOLD_WINDOW, MST_SLEEP, MST_TURN, MST_LIGHTLY_HOLD, MST_HOLD, MST_DEFAULT, MST_DAMAGE, MST_DOWN, MST_STANDUP, MST_TURNOVER, MST_END };
