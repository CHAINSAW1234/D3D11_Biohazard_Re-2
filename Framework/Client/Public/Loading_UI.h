...
{
private:
	enum class LOADING_UI_TYPE { BACKGROUND_TEXT, BACKGROUND_LOADING_UI, TYPING_BACKGROUND_LOADING_UI, TYPING_BODY_LOADING_UI, ROLLING_LOADING_UI, TYPING_HEAD_LOADING_UI, BAR_LOADING_UI, END_LOADING_UI };
