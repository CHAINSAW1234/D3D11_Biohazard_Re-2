...
public: /* For.Font_Manager */
	...
	HRESULT									Render_Font(const wstring& strFontTag, const wstring& strText, const _float2& vPosition, _fvector vColor, _float fRadian, _float fScale = 1.f);
...
public: /* For.m_pSound_Manager */
	...
	void									Change_Sound_3D(CTransform* pTransform, const wstring& strSoundTag, _uint iSoundIndex, _bool isCullSameSound = false);
...
#pragma region Sound_Manager_2D
	...
	void									PlaySoundEffect_2D(wstring TypeKey, wstring FileKey, _int eID, _float Volume);
