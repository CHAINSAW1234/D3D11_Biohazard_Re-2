...
public:
	...
	const vector<_uint>&				Get_CurrentKeyFrameIndices() { return m_CurrentKeyFrameIndices; }
	string								Get_Name() { return m_szName; }

	void								Set_KeyFrameIndex(_uint iKeyFrameIndex);
	void								Set_TrackPosition(_float fTrackPostion) { m_fTrackPosition = fTrackPostion; }
