...
HRESULT CBody_Player::Add_Components()
{
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_TOOL, TEXT("Prototype_Component_Model_LeonBody"),
	...
	for (_uint i = 0; i < 100; ++i)
	{
		...
		CComponent* pCollider = { m_pGameInstance->Clone_Component(LEVEL_TOOL, TEXT("Prototype_Component_Collider_OBB"), &ColliderOBBDesc) };
