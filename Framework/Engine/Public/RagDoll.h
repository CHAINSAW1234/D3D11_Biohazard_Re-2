...
public:
    ...
    std::vector<_vector>                        m_relative_joint_pos_BreakPart_Cloth;
    std::vector<_vector>                        m_original_body_rotations_BreakPart_Cloth;
    std::vector<_vector>                        m_body_pos_relative_to_joint_BreakPart_Cloth;
    std::vector<_vector>                        m_original_joint_rotations_BreakPart_Cloth;
...
public:
    ...
    struct PoseTransforms* apply_BreakPart_Cloth(CRagdoll* ragdoll, _matrix model_scale, _matrix model_rotation, vector<_bool>* pBreakPart);
...
private:
    ...
    PoseTransforms  m_transforms_BreakPart_Cloth;
};
