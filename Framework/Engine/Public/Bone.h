...
public:
	...
	_float4x4*				Get_ParentCombinedMatrix_RagDoll_Ptr(_uint iRagDollIndex);

	void					Set_Combined_Matrix(_fmatrix CombinedMatrix);
	void					Set_Parent_CombinedMatrix_Ptr(_float4x4* pParentMatrix);
	void					Set_Parent_CombinedMatrix_Ptr_RagDoll(_uint iRagDollIndex, _float4x4* pParentMatrix);
	...
	_bool					Is_Set_ParentCombiend_RagDoll(_uint iRagDollIndex);
	void					Resize_ParentCombinedMatrices_RagDoll(_uint iNumRagDoll);
...
private:
	...
	vector<_float4x4*>		m_pParentCombinedMatrices_RagDoll;
