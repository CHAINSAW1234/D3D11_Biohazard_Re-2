...
#define SOUND_2D_NUM_CHANNEL			512
#define SOUND_3D_NUM_CHANNEL			1536
#define SOUND_CHANNEL_MAX				SOUND_2D_NUM_CHANNEL + SOUND_3D_NUM_CHANNEL
#define SOUND_DEFAULT_VOLUME			1.f
#define SOUND_DEFAULT_MIN_DISTANCE		1.f
#define SOUND_DEFAULT_MAX_DISTANCE		40.f
