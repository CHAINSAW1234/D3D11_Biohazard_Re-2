...
void CCharacter_Controller::Create_Collider()
{
	...
	m_BodyCollider = create_capsule_bone(m_spine_01_idx, m_neck_01_idx, *m_ragdoll, 7.0f*1.45f, rot, COLLIDER_TYPE::CHEST);
	m_Pelvis_Collider = create_capsule_bone(m_pelvis_idx, m_spine_01_idx, *m_ragdoll, 7.0f * 1.45f, rot, COLLIDER_TYPE::PELVIS);
